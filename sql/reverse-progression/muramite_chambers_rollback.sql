-- MURAMITE CHAMBERS ROLLBACK (PREVIEW PACKAGE)
-- Restores only npc_types and spawn2 from backup tables

UPDATE npc_types t
JOIN npc_types_backup_muramite_chambers_classic_20260516 b ON b.id = t.id
SET
  t.level = b.level,
...
UPDATE spawn2 s
JOIN spawn2_backup_muramite_chambers_respawn_20260516 b ON b.id = s.id
