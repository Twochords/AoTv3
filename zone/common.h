...
struct StatBonuses {
	...
	int32   WeaponDamageFlatBonus;         // SPA 533: flat weapon damage added per hit when endurance is available
	int32   WeaponDamageFlatBonusEndurCost; // SPA 533: endurance cost per hit gating WeaponDamageFlatBonus
